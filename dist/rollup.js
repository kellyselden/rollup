/*
	Rollup.js v0.59.1
	Fri, 01 Jun 2018 01:41:55 GMT - commit 1bc4681f324e0afadffcbdcdf999751f43f4e154
...
var ShimVariable = /** @class */ (function (_super) {
    __extends(ShimVariable, _super);
    function ShimVariable() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return ShimVariable;
}(Variable));
...
var Module = /** @class */ (function () {
    ...
    Module.prototype.shimMissingExport = function (name) {
        ...
        var shim = Object.keys(this.exports)
            .map(function (name) { return _this.exports[name].shim; })
            .filter(Boolean)[0];
        if (!shim) {
...
function system(magicString, _a) {
    ...
    exports.forEach(function (expt) {
        var exportString = "exports('" + expt.exported + "', " + expt.local + ");";
        // function declarations hoist
        if (expt.hoisted)
            functionExports.push(exportString);
        if (expt.shim)
            shimExports.push(exportString);
    });
...
var C__code_rollup_node_modules_minimalisticAssert = assert;
...
function join32(msg, start, end, endian) {
  var len = end - start;
  C__code_rollup_node_modules_minimalisticAssert(len % 4 === 0);
...
BlockHash.prototype.digest = function digest(enc) {
  ...
  C__code_rollup_node_modules_minimalisticAssert(this.pending === null);
...
SHA256.prototype._update = function _update(msg, start) {
  ...
  C__code_rollup_node_modules_minimalisticAssert(this.k.length === W.length);
...
var Chunk$1 = /** @class */ (function () {
    ...
    Chunk.prototype.setIdentifierRenderResolutions = function (options) {
        ...
        this.orderedModules.forEach(function (module) {
            ...
            var shimSafeName;
            for (var _i = 0, _a = Object.keys(_this.exportNames); _i < _a.length; _i++) {
                var exportName = _a[_i];
                var exportVariable = _this.exportNames[exportName];
                if (!exportVariable)
                    continue;
                var newExportName = void 0;
                if (exportVariable instanceof ShimVariable) {
                    if (_this.exports.get(exportVariable) !== module) {
                        continue;
                    }
                    if (!shimSafeName) {
                    ...
                    if (_this.graph.shimMissingExports) {
    ...
    Chunk.prototype.getChunkExportDeclarations = function () {
        ...
        var _loop_2 = function (exportName) {
            ...
            if (variable instanceof ShimVariable) {
                if (!exports.find(function (expt) { return expt.shim; })) {
                    exports.push({
                        local: localName,
                        exported: localName,
                        hoisted: false,
    ...
    Chunk.prototype.preRender = function (options, inputBase) {
        ...
        var shim = Object.keys(this.exportNames)
            .map(function (exportName) {
            return _this.exportNames[exportName];
        })
            .find(function (variable) {
            return variable instanceof ShimVariable;
        });
        if (shim) {
            var originModule = this.exports.get(shim);
...
var Graph = /** @class */ (function () {
    function Graph(options) {
        ...
        this.handleMissingExport = firstSync(this.plugins
            ...
            .concat(this.shimMissingExports ? function () { } : handleMissingExport));
...
var C__code_rollup_node_modules_rollupPluginutils_node_modules_isExtglob = function isExtglob(str) {
...
var C__code_rollup_node_modules_rollupPluginutils_node_modules_isGlob = function isGlob(str) {
  return typeof str === 'string'
    && (/[*!?{}(|)[\]]/.test(str)
     || C__code_rollup_node_modules_rollupPluginutils_node_modules_isExtglob(str));
};
...
var C__code_rollup_node_modules_rollupPluginutils_node_modules_normalizePath = function normalizePath(str, stripTrailing) {
  if (typeof str !== 'string') {
    throw new TypeError('expected a string');
  }
  str = str.replace(/[\\\/]+/g, '/');
...
var C__code_rollup_node_modules_parseGlob_node_modules_isExtglob = function isExtglob(str) {
  return typeof str === 'string'
    && /[@?!+*]\(/.test(str);
};
...
var C__code_rollup_node_modules_parseGlob_node_modules_isGlob = function isGlob(str) {
  return typeof str === 'string'
    && (/[*!?{}(|)[\]]/.test(str)
     || C__code_rollup_node_modules_parseGlob_node_modules_isExtglob(str));
};
...
var C__code_rollup_node_modules_globParent_node_modules_isExtglob = function isExtglob(str) {
  return typeof str === 'string'
    && /[@?!+*]\(/.test(str);
};
...
var C__code_rollup_node_modules_globParent_node_modules_isGlob = function isGlob(str) {
  return typeof str === 'string'
    && (/[*!?{}(|)[\]]/.test(str)
     || C__code_rollup_node_modules_globParent_node_modules_isExtglob(str));
};

var C__code_rollup_node_modules_globParent = function globParent(str) {
	str += 'a'; // preserves full path in case of trailing path separator
	do {str = path__default.dirname(str);} while (C__code_rollup_node_modules_globParent_node_modules_isGlob(str));
	return str;
};
...
var C__code_rollup_node_modules_globBase_node_modules_isExtglob = function isExtglob(str) {
  return typeof str === 'string'
    && /[@?!+*]\(/.test(str);
};
...
var C__code_rollup_node_modules_globBase_node_modules_isGlob = function isGlob(str) {
  return typeof str === 'string'
    && (/[*!?{}(|)[\]]/.test(str)
     || C__code_rollup_node_modules_globBase_node_modules_isExtglob(str));
};
...
var C__code_rollup_node_modules_globBase = function globBase(pattern) {
  ...
  res.isGlob = C__code_rollup_node_modules_globBase_node_modules_isGlob(pattern);
...
module.exports = function parseGlob(glob) {
  ...
  if (C__code_rollup_node_modules_parseGlob_node_modules_isGlob(tok.path.dirname) && !tok.path.basename) {
    if (!/\/$/.test(tok.glob)) {
  ...
  tok.is.extglob  = glob && C__code_rollup_node_modules_parseGlob_node_modules_isExtglob(glob);
...
utils.isExtglob = C__code_rollup_node_modules_rollupPluginutils_node_modules_isExtglob;
utils.isGlob = C__code_rollup_node_modules_rollupPluginutils_node_modules_isGlob;
utils.typeOf = C__code_rollup_node_modules_kindOf;
utils.normalize = C__code_rollup_node_modules_rollupPluginutils_node_modules_normalizePath;
...
var C__code_rollup_node_modules_rollupPluginutils_node_modules_micromatch = micromatch;
...
function createFilter ( include, exclude ) {
	const getMatcher = id => ( isRegexp( id ) ? id : { test: C__code_rollup_node_modules_rollupPluginutils_node_modules_micromatch.matcher( path.resolve( id ) ) } );
