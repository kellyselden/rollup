...
export declare function findFirstOccurrenceOutsideComment(
	code: string,
	searchString: string,
	start?: number
): number;
export declare function renderStatementList(
	statements: Node[],
	code: MagicString,
	start: number,
	end: number,
...
export declare function getCommaSeparatedNodesWithBoundaries<N extends Node>(
	nodes: N[],
	code: MagicString,
	start: number,
	end: number
