...
var C__code_rollup_node_modules_globParent = function globParent(str) {
	...
	do {str = path.dirname(str);} while (C__code_rollup_node_modules_globParent_node_modules_isGlob(str));
	return str;
};
...
function createFilter ( include, exclude ) {
	const getMatcher = id => ( isRegexp( id ) ? id : { test: C__code_rollup_node_modules_rollupPluginutils_node_modules_micromatch.matcher( resolve( id ) ) } );
