/*
	Rollup.js v0.63.5
	Fri, 03 Aug 2018 14:57:08 GMT - commit d500ab3c10542a4891f2d7625a819f5f74cb2b24
...
import path, { basename, extname, relative, dirname, resolve, sep } from 'path';
...
var Chunk$1 = /** @class */ (function () {
    ...
    Chunk.prototype.preRender = function (options) {
        ...
        if (this.needsExportsShim) {
            var variable = this.graph.exportShimVariable.getName();
    ...
    Chunk.prototype.render = function (options, addons, inputBase) {
        var _this = this;
        ...
        var getPath = this.createGetPath(options, inputBase);
        ...
        for (var i = 0; i < this.dependencies.length; i++) {
            ...
            var depId = dep.id;
            var normalizePrefix = true;
            if (dep instanceof ExternalModule) {
                depId = renderedDependency.id;
                normalizePrefix = isAbsolute(depId);
            }
            var relPath = getPath(depId, normalizePrefix);
            if (dep instanceof Chunk)
    ...
    Chunk.prototype.createGetPath = function (options, inputBase) {
        var _this = this;
        var optionsPaths = options.paths;
        var fallback = function (id, normalizePrefix) {
            if (!normalizePrefix) {
                return id;
            }
            var path$$1;
            if (_this.id) {
                var base = isAbsolute(id) ? inputBase : dirname(_this.id);
                path$$1 = normalize(relative(base, id));
            }
            else {
                path$$1 = id;
            }
            return addPathPrefix(path$$1);
        };
        if (!optionsPaths) {
            return fallback;
        }
        var getPathForId = typeof optionsPaths === 'function'
            ? function (id) { return optionsPaths(id, addPathPrefix(_this.id)); }
            : function (id) { return optionsPaths[id]; };
        return function getPath(id, normalizePrefix) {
            var normalizedId = normalizePrefix ? addPathPrefix(id) : id;
            ...
            function generate(rawOutputOptions, isWrite) {
                ...
                return createAddons(graph_1, outputOptions)
                    ...
                    return Promise.all(chunks.map(function (chunk) {
                        ...
                        return chunk.render(outputOptions, addons, inputBase).then(function (rendered) {
